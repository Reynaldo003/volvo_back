...
def es_video_evidencia(evidencia):
...
def bloque_evidencias_pdf(entrega, estilos):
    evidencias = []

    for evidencia in entrega.evidencias.all().order_by("creado"):
...
def generar_pdf_checklist_entrega(entrega):
    ...
    story.extend(bloque_evidencias_pdf(entrega, estilos))
